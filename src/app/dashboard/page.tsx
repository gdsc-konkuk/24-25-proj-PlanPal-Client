...
import { Calendar, MapPin, Plus, Users, MessageSquare, Copy, Check, X, ImageIcon } from "lucide-react"
  ...
  const travelRooms: TravelRoom[] = [
    {
      ...
      participants: [
        { id: "user1", name: "나", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user2", name: "김철수", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user3", name: "이영희", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user4", name: "박지민", avatar: "/placeholder.svg?height=40&width=40" },
      ],
      lastMessage: {
        sender: "이영희",
    ...
    },
    {
      ...
      participants: [
        { id: "user1", name: "나", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user5", name: "정민수", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user6", name: "한소희", avatar: "/placeholder.svg?height=40&width=40" },
      ],
      lastMessage: {
        sender: "정민수",
    ...
    },
    {
      ...
      participants: [
        { id: "user1", name: "나", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user7", name: "최준호", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user8", name: "강다희", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user9", name: "윤서연", avatar: "/placeholder.svg?height=40&width=40" },
        { id: "user10", name: "임재현", avatar: "/placeholder.svg?height=40&width=40" },
      ],
      lastMessage: {
        sender: "강다희",
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-8">
        ...
        <Button className="bg-accent text-accent-foreground hover:bg-accent/90" onClick={openCreateDialog}>
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          <DialogContent className="sm:max-w-[600px] max-h-[calc(100vh-40px)] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>새로운 여행 계획을 만들고 친구들과 함께 준비해보세요.</DialogDescription>
            </DialogHeader>

            <Tabs defaultValue="basic" value={activeTab} onValueChange={setActiveTab} className="mt-4">
              <TabsList className="grid w-full grid-cols-2">
                <TabsTrigger value="basic">기본 정보</TabsTrigger>
                <TabsTrigger value="invite" disabled={!newTravelName || newTravelParticipants < 1}>
                  초대 및 시작
                </TabsTrigger>
              </TabsList>
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid gap-4">
                      ...
                      <div className="grid gap-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setNewTravelParticipants(Number.parseInt(e.target.value) || 1)}
                          required
                        />
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid gap-4">
                      ...
                      <div className="grid gap-2">
                        <Label>여행 기간</Label>
                        <DatePickerWithRange date={newTravelDate} setDate={setNewTravelDate} />
                      </div>
              ...
              <TabsContent value="invite" className="space-y-4 py-4">
                <div className="space-y-6">
                  ...
                  <div className="bg-muted/50 rounded-lg p-6 text-center">
                    <h3 className="text-lg font-medium mb-2">여행 계획이 생성되었습니다!</h3>
                    <p className="text-muted-foreground mb-6">아래 링크를 공유하여 친구들을 초대하세요.</p>

                    <div className="flex items-center gap-2 mb-6">
                      <Input
                        value={inviteLink || "https://planpal.vercel.app/invite/sample-invite-code"}
                        readOnly
                      ...
                      <Button
                        ...
                        className={cn("transition-colors", linkCopied && "bg-green-50 text-green-600 border-green-200")}
                      >
                  ...
                  <div className="border rounded-lg overflow-hidden">
                    <div className="relative h-40">
                      ...
                      <div className="absolute bottom-0 left-0 right-0 p-4">
                        <h3 className="text-white font-bold text-xl mb-1">{newTravelName}</h3>
                        {destinations.length > 0 && (
                          <div className="flex items-center text-white/90 text-sm">
                            <MapPin className="h-3 w-3 mr-1" />
                            <span>
                              {destinations.map((d) => `${d.country}${d.region ? ` - ${d.region}` : ""}`).join(", ")}
                            </span>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="p-4 bg-background">
                      ...
                      {newTravelDescription && (
                        <p className="text-sm text-foreground/80 mt-2">{newTravelDescription}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between pt-4">
                  ...
                  <Button className="bg-accent text-accent-foreground hover:bg-accent/90" onClick={handleStartTravel}>
                    여행 시작하기
                  </Button>
                </div>
              </TabsContent>
            ...
            <CardContent className="p-4">
              <div className="flex justify-between items-center mb-3">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-foreground/70">{room.participants.length}명</span>
                </div>
              </div>
              ...
              <div className="bg-muted/50 rounded-lg p-3">
                <div className="flex items-center mb-1">
                  ...
                  <span className="text-xs font-medium">{room.lastMessage.sender}</span>
                  <span className="text-xs text-foreground/50 ml-auto">
                    {format(room.lastMessage.timestamp, "MM/dd HH:mm")}
                  </span>
                </div>
                <p className="text-sm text-foreground/80 truncate">{room.lastMessage.content}</p>
              </div>
            </CardContent>
